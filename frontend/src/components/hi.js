...
const ProductDetails = ({ addToCart, addToWishlist, cart }) => {
    ...
    //             console.log("API Response:", response.data); // Check structure here
    //             setReviews(response.data); // Assuming this sets an array of reviews
    //         } catch (err) {
    ...
    //             // Update reviews list with the new review from response
