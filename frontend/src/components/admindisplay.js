    ...
    <>
      <div className="admin-container">
        ...
        {/* <div className="sidebar" style={{ padding: '10px', height: '100vh' }}>
          ...
          <ul className="sidebar-menu" style={{ padding: '0', margin: '0' }}>
            <li><Link to="/displayproduct"><i className="fas fa-box me-2"></i>Products</Link></li>
            <li><Link to="/admincustomers"><i className="fas fa-users me-2"></i>Users</Link></li>
            <li><Link to="/adminpending"><i className="fas fa-truck me-2"></i>Pending Orders</Link></li>
            <li><Link to="/adminorders"><i className="fa-solid fa-pen-to-square me-2"></i>Orders</Link></li>
            <li><Link to="/addproducts"><i className="fa-solid fa-cart-plus me-2"></i>Add Product</Link></li>
